...
import { CITY_LIST } from "../../data/location";
import { getDistrictList } from "./helpers";
  ...
  return (
    <div>
      ...
      <Input
        value={surname.value}
        onChange={(event) =>
          updateField("surname", { value: event.currentTarget.value })
        }
        id="surname"
        label="Surname"
      />
      ...
      <Select
        ...
        onChange={(value) => updateField("district", { value: Number(value) })}
      />
      <Input
        value={address.value}
        onChange={(event) =>
